<template>
  <div>
    <header class="nav-opt-sprite nav-locate-us nav-long-en nav-ssl vac-unrec">
            ...
            <div class="nav-global-location">
              <nuxt-link to='/address' class="nav-a nav-a-2">
                ...
                <div id="glow-ingress-block">
                  <span class="nav-line-1" id="glow-ingress-line-1">Delirver to</span>
                  <span class="nav-line-2" id="glow-ingress-line-2">Albania</span>
                </div>
              </nuxt-link>
            </div>
          </div>

          ...
          <div class="a-section">
            ...
            <form>
              ...
              <div class="a-spacing-medium">
                ...
                <select value="1" class="a-select-option" v-model='categoryID'>
                  <option v-for='category in categories' :value='category._id' :key='category._id'>{{ category.type }}</option>
                </select>
                <!-- <input v-model='category._id'> -->
              </div>
              <!-- Owner Dropdown -->
              <div class="a-spacing-medium">
                <label>Owner</label>
                <select value="1" class="a-select-option" v-model='ownerID'>
              ...
              <div class="a-spacing-top-medium">
                ...
                <textarea style="width: 100%;" :placeholder="product.description"></textarea>
              </div>
              <!-- Photo File -->
              <div class="a-spacing-top-medium">
  ...
  export default {
    async asyncData({ $axios, params }) {
      ...
      try {
        ...
        const [catResponse, ownerResponse, productReponse] = await Promise.all([
          categories,
          owners,
          product,
        ]);

      ...
      <div class="row">
        ...
        <div class="col-xl-10 col-lg-9 md-8 col-sm-8">
          ...
          <div class="mainResults">
            <ul v-for="product in products" :key='product._id' class="s-result-list">
                  ...
                  <div>
                    <div class="row">
                      ...
                      <div class="col-sm-3 text-center">
                        <a href="#">
                          <img :src="product.photo" style="width:175px" class="img-fluid">
                        </a>
                      </div>
                      ...
                      <div class="col-sm-9">
                        <div class="a-row a-spacing-small">
                          ...
                          <a href="#" class="a-link-normal">
                            <h2 class="a-size-medium">
                              ...
                              <span class="a-letter-space"></span>
                              <span class="a-size-small a-color-secondary">Sep 9, 2021</span>
                            </h2>
                          </a>
                        </div>
                        ...
                        <!-- Shipment -->
                        <div class="a-row">
                          <span class="a-size-small">Ships to AL</span>
                        </div>
                          ...
                          <div class="col-sm-7">
                            ...
                            <div class="a-row a-spacing-none">
                              <a href="#" class="a-link-normal a-text-normal">
                                ...
                                <span class="a-color-base xs-zero-spacing">
                                  <span class="xs-price xs-price-large">
                                    <sup class="xs-price-currency">$</sup>
                                    <span class="xs-price-whole">{{ product.price }}</span>
                                    <sup class="xs-price-fractional">00</sup>
                                  </span>
                                </span>
                              </a>
                              <span class="a-letter-space"></span>
